 ...
 *
 */
public class AdministrationPreProcessingFilter extends PreProcessingFilter {

	public AdministrationPreProcessingFilter(PreProcessingFilter nextFilter) {
        super(nextFilter);
    }
    ...
    protected ActionForward doProcess(HttpServletRequest request, 
        ...
        if (webGardenActionMapping.getAdministrationRequired()) {
