 ...
 *
 */
public class EditProductDetailsForm extends ActionForm {
...
//	public int getCategoriaAsInt() {
//		return categoriaAsInt;
//	}
	...
	public ActionErrors validate(ActionMapping mapping, 
		...
		precioAsDouble = PropertyValidator.validateDouble(errors, 
				"precio", precio, true, 1, 
				Integer.MAX_VALUE, request.getLocale());
//		categoriaAsInt = PropertyValidator.validateInt(errors, 
//				"categoria", categoria, true, 1, Integer.MAX_VALUE);
		...
		PropertyValidator.validateMandatory(errors, "categoria", categoria);
