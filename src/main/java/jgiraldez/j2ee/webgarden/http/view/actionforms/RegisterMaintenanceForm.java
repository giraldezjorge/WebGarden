 ...
 *
 */
public class RegisterMaintenanceForm extends ActionForm {
...
//	}
	...
	public Timestamp getTimestamp() {
		...
		return Timestamp.valueOf(this.year + "-" + this.month + "-" + this.day 
...
//      idMantenimientoAsInt = new Integer(PropertyValidator.validateInt(
//        	errors, "idMantenimiento", idMantenimiento, 
//        	true, 0, Integer.MAX_VALUE));
        
        PropertyValidator.validateInt(errors, "day", day, true, 
        		DateRanges.FIRST_DAY, DateRanges.LAST_DAY);
        PropertyValidator.validateInt(errors, "month", month, true, 
        		DateRanges.FIRST_MONTH, DateRanges.LAST_MONTH);
        PropertyValidator.validateInt(errors, "year", year, true, 
        		DateRanges.FIRST_YEAR, dateRanges.getLastYear());
        PropertyValidator.validateInt(errors, "hour", hour, true, 
        		DateRanges.FIRST_HOUR, DateRanges.LAST_HOUR);
        PropertyValidator.validateInt(errors, "minutes", minutes, true, 
        ...
        PropertyValidator.validateMandatory(errors, "cliente", cliente);
