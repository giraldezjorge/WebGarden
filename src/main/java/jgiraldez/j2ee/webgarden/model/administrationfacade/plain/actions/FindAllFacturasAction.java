 ...
 *
 */
public class FindAllFacturasAction implements NonTransactionalPlainAction {

	private int startIndex;
	private int count;
	
	public FindAllFacturasAction(int startIndex, int count) {
	...
	public Object execute(Connection connection) throws InternalErrorException {
		...
		List<FacturaVO> facturaVOs = 
			facturaDAO.findAll(connection, startIndex, count + 1);
